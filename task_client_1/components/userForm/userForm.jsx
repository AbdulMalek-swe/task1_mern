...
<div className="h-screen flex items-center ">
    ...
    <div className="flex items-center justify-center    md:w-1/2 h-full    ">
        <div className='flex justify-center'>
            ...
            <div className=' mr-20 ml-20 lg:ml-20 lg:mr-20 md:ml-8 md:mr-8 '>
                ...
                <div className='text-center lg:mb-10 mb-5'>
                    <h1 className='mb-4 font-bold lg:text-3xl text-2xl font-sans text-black leading-10 uppercase'> {pathName?'Get started now ✨':"Welcome back 👋"}</h1>


                    <p className="text-gray-500 lg:text-lg text-base">Lorem ipsum dolor sit amet consectetur. Hendrerit vulputate vitae gravida risus rhoncus. Montes nam amet</p>
                </div>
                <Formik
                    enableReinitialize
                    initialValues={{
                    ...
                    {({
                        ...
                        <form onSubmit={handleSubmit} className='capitalize'>
                           { pathName &&<div className="mb-4  ">
                                <label htmlFor=" fullName" className="block lg:text-xl text-base font-normal text-gray-700 leading-4">
                                   Full name
      ...
      />
                            ...
                            <div className="mb-4">
                                <label htmlFor="email" className="block lg:text-xl text-base font-normal text-gray-700  leading-4">
      ...
      />
                            ...
                            <div className="mb-4">
                                <label htmlFor="password" className="block lg:text-xl text-base font-normal text-gray-700  leading-4">
      ...
      >
        <div className="grid grid-cols-2  w-full  ">
            <div className={`${selectedValue==='admin'?'text-blue-600 border border-blue-600':''}  rounded-xl   text-center`}>
            <FormControlLabel  fullWidth value="admin" control={<Radio />} label="Admin"  />
            </div>
        <div className={`${selectedValue==='user'?'text-blue-600 border border-blue-600 ':''}  rounded-xl   text-center`}>
        <FormControlLabel value="user" control={<Radio />} label="User"  />
                           ...
                           {pathName&&<div className="mb-8 flex items-center">
                            <Checkbox  {...label}   /> <p className='text-black8'> I agree to all the 
                ...
                <div className=" rounded-xl text-black8 text-center   bg-white flex justify-center lg:mt-10 mt-5">
                    {pathName && <p className='text-black8'> A an account?
                    ...
                    {!pathName && <p className='text-black8'> Don't have an account?
                     <Link href="/userForm/register" className="text-blue-600 hover:underline"> Log in</Link>
                    </p>}
    ...
    <div className="bg-formImg    bg-cover   bg-no-repeat bg-static  h-screen w-1/2 ">
        <div className="w-full h-full   bg-white8 text-left ">
            <div className="mr-10 ml-10 lg:ml-10 lg:mr-110 md:ml-5 md:mr-5 flex items-end    h-full pb-10">
                <div className="border  lg:p-7 md:p-5 p-3 bg-gradient-to-r from-formdowncolor1 to-formdowncolor2 text-white rounded-lg">
                    <div>
                        <p className="xl:text-2xl lg:text-xl md:text-lg text-base">Given a full text query such das rotes Kleid our approach retrieves matching product images. You can try different queries in the demo and visually inspect retrieved images.</p>
                    </div>
